# Contributing to TiDEomics

This outlines how to propose a change to TiDEomics. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hte123/TiDEomics", fork = TRUE)`.
...
Code of Conduct](https://hte123.github.io/TiDEomics/CODE_OF_CONDUCT.md).
